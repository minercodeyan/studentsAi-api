...
/**
 * Class EmailbroadcastCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EmailbroadcastCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(EmailbroadcastRequest::class);

        CRUD::field('title');
        CRUD::field('broadcast_message');
        $this->crud->addFields([
            [
                'name'  => 'groups',
                'label' => 'Группы по которым пойдет рассылка',
